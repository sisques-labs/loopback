...
import { getDashboardErrorStrings } from "@/features/dashboard/i18n/error-strings";
...
export default function DashboardError({
  ...
  const strings = getDashboardErrorStrings(localeSegment);
  ...
  const endpoint =
    process.env.NEXT_PUBLIC_AWS_ENDPOINT_URL ?? "http://localhost:4566";
