...
const dict = {
  ...
  createFunctionDialog: {
    ...
    runtimePlaceholder: "Selecciona un runtime",
    ...
    roleHint: "Valor por defecto de LocalStack. Reemplázalo con un ARN real al apuntar a AWS.",
    cancel: "Cancelar",
    submit: "Crear",
    creating: "Creando…",
  ...
  createFunctionValidation: {
    ...
    invalidRuntime: "Selecciona un runtime válido.",
  ...
  invokeDialog: {
    ...
    payloadPlaceholder: "Deja vacío o introduce un objeto JSON válido…",
    cancel: "Cancelar",
    submit: "Invocar",
    invoking: "Invocando…",
  ...
  updateCodeDialog: {
    ...
    fileHint: "Sube un archivo .zip (hasta 50 MB).",
