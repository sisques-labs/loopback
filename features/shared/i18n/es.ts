...
const dict = {
  ...
  settings: {
    ...
    regionDescription: "Selecciona la región de AWS para tu entorno local",
    ...
    regionProfileActiveInfo: "La región está controlada por el perfil activo. Edita el perfil para cambiarla.",
    ...
    profileDeleteActive: "Desactiva el perfil antes de eliminarlo",
    ...
    profileDeleteConfirm: "¿Estás seguro de que quieres eliminar este perfil?",
